...
Subagent、Workflow 与 Jobs 都能让工作脱离当前同步 Tool Call，但三者解决的问题不同：Subagent 是任务委派，Workflow 是多 Agent 编排，Jobs 是后台任务生命周期。当前版本还提供实验性的 Agent Teams，用于多个可继续 Agent 之间的长期协作。本页先帮助选择机制，左侧随后四篇文章分别展开其独立边界。
